<!--
  HISTORICAL V1 — NOT PRODUCTION.

  This document described the legacy OP_RETURN Cove V1 indexer-authoritative
  model (signet, treasury/settlement scripts, ticker registry, account balances).
  It has been superseded by the V3 token-UTXO + backing-reserve protocol.

  See docs/TRUST_MODEL.md for the CURRENT production trust model.
-->
