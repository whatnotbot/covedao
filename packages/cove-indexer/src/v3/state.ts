...
import { COVE_FEE_CONFIG, deterministicFee, isP2TR, isP2WPKH } from "@crclaunch/cove-economics";
...
export class V3IndexerState {
  ...
  private applyMint(
    ...
    const feeSats = deterministicFee(grossSats, COVE_FEE_CONFIG.buyFeeBps);
  ...
  private applyRedeem(
    ...
    const feeSats = deterministicFee(grossSats, COVE_FEE_CONFIG.redeemFeeBps);
